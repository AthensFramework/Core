Athens\Core\Filter\PaginationFilter
===============
...
### getType
    ...
    string Athens\Core\Filter\PaginationFilter::getType()
...
### getNumPages
    ...
    integer Athens\Core\Filter\PaginationFilter::getNumPages()
...
### getPage
    ...
    integer Athens\Core\Filter\PaginationFilter::getPage()
