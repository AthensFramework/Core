...
use UWDOEMTest\TestClassTwoQuery;
...
class TestClassTwoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'UWDOEMTest.Map.TestClassTwoTableMap';
     ...
     */
    const OM_CLASS = '\\UWDOEMTest\\TestClassTwo';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'UWDOEMTest.TestClassTwo';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\UWDOEMTest\\TestClassTwo');
    ...
    {
        $this->addRelation('TestClass', '\\UWDOEMTest\\TestClass', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':test_class_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \UWDOEMTest\TestClassTwo) { // it's a model object
