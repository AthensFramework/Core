 ...
 * @method string getDefaultWriterClass()
 * @method string getDefaultExcelWriterClass()
 * @method string getDefaultPDFWriterClass()
 ...
 * @method string getDefaultIntializerClass()
